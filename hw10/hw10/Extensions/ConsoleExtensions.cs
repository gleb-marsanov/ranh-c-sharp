...
internal static class ConsoleExtensions
{
    ...
    public static string ToStringTable(this Worker[] workers)
    {
        ...
        int creationDateColumnWidth = Math.Max(workers.Max(x => x.CreationDate.ToString("dd.MM.yyyy hh:mm").Length), creationDateColumn.Length);
        ...
        int birthDateColumnWidth = Math.Max(workers.Max(x => x.BirthDate.ToString().Length), dateColumn.Length);
